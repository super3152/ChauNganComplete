...
public class BLLThuChi {
    ...
    public static void ThemPhieuThuBanHang(DTOPhieuThuChi ptc) {
        DAO.DAOThuChi.ThemPhieuThuBanHang(ptc);
    }

    public static void ThemPhieuChiNhapHang(DTOPhieuThuChi ptc) {
        DAO.DAOThuChi.ThemPhieuChiNhapHang(ptc);
    }
}
