 ...
 */
public class jdlTraNoKhachHang extends javax.swing.JDialog {

    /**
     * Creates new form jdlTraNoKhachHang
     */
    public jdlTraNoKhachHang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         int dongDuocChon = pnlChiTietKhachHang.tblCTKH.getSelectedRow();
        lblTenKhachHang.setText(pnlChiTietKhachHang.lblTenKhachHang.getText());
        txtNoHoaDon.setText( pnlChiTietKhachHang.tblCTKH.getValueAt(dongDuocChon, 6).toString());
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Thông tin thanh toán cho khách");
        ...
        pnlTitleLayout.setHorizontalGroup(
            ...
            .addGroup(pnlTitleLayout.createSequentialGroup()
                ...
                .addComponent(lblTenKhachHang, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
          if (BLL.ChuyenDoi.ChuyenTien(txtThanhToan.getText()) < BLL.ChuyenDoi.ChuyenTien(txtNoHoaDon.getText())) {
                ThongBaoCanhBao.ThongBao("Khách chưa trả đủ tiền nợ !", "Thông Báo !");
                return;
            }
        int dongDuocChon = pnlChiTietKhachHang.tblCTKH.getSelectedRow();       
        int MaHD = BLL.BLLHoaDon.LayMaHoaDonString(pnlChiTietKhachHang.tblCTKH.getValueAt(dongDuocChon, 2).toString());
        ...
        DTO.DTOHoaDon shd = new DTO.DTOHoaDon(MaHD, TrangThai, CongNoHD);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdlTraNoKhachHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdlTraNoKhachHang dialog = new jdlTraNoKhachHang(new javax.swing.JFrame(), true);
