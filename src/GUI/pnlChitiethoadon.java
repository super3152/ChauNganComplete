...
public class pnlChitiethoadon extends javax.swing.JPanel {
    ...
    public pnlChitiethoadon() {
        ...
        double Thue = 0, UuDai = 0, TongTien = hd.getTongTien();
        if (tblChiTietHoaDon !=null) {
             for (int i = 0; i < tblChiTietHoaDon.getRowCount(); i++) {
            Thue = Thue + Double.parseDouble(tblChiTietHoaDon.getValueAt(i, 9).toString());
            UuDai = UuDai + Double.parseDouble(tblChiTietHoaDon.getValueAt(i, 7).toString());

        }
        double TienHang = TongTien - Thue - UuDai;
        lblTienHang.setText(ChuyenDoi.DinhDangTien(TienHang));
        lblTienThue.setText(ChuyenDoi.DinhDangTien(Thue));
    ...
    private void initComponents() {
        ...
        tblChiTietHoaDon.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Ảnh", "Mã SP", "Tên SP", "Size", "Màu", "Số lượng", "Đơn giá", "Ưu đãi", "Thuế", "Thành tiền"
            }
        ) {
