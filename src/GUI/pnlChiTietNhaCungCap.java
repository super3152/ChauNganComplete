...
import static GUI.pnlhanghoa.txttimkiem6;

/**
 *
 * @author Administrator
 */
public class pnlChiTietNhaCungCap extends javax.swing.JPanel {

    /**
     * Creates new form pnlChiTietKhachHang
     */
    public static int MaNCC;

    public pnlChiTietNhaCungCap() {
        initComponents();
        BLL.BLLNhaCungCap.HienThiChiTietNhaCungCap(tblCTNCC, MaNCC);
        DTO.DTONhaCungCap ncc = BLL.BLLNhaCungCap.GetMaNCC(MaNCC);
        lblTenNhaCungCap.setText(ncc.getTenNhaCungCap());
        lblSoDienThaoi.setText(ncc.getSoDienThoai());
        lblEmail.setText(ncc.getEmail());
        lblMaNhaCungCap.setText(ncc.getMaNhaCungCap());
        lblMaSoThue.setText(ncc.getMaSoThue());
        lblDiaChi.setText(ncc.getDiaChi());

        lblTongTienHang.setText(ChuyenDoi.DinhDangTien(ncc.getTongTienHang()));
        lblSoLanNhapHang.setText(tblCTNCC.getRowCount() + "");
        lblNo.setText(ChuyenDoi.DinhDangTien(ncc.getCongNo()));
        if (ncc.getCongNo() == 0) {
    ...
    public pnlChiTietNhaCungCap(int MaNCC) {
        initComponents();
        pnlChiTietNhaCungCap.MaNCC = MaNCC;
    ...
    private void initComponents() {
        ...
        lblSoLanNhapHang = new javax.swing.JLabel();
        ...
        tblCTNCC = new javax.swing.JTable();
        ...
        lblnhanvienphutrach.setText("Tên Nhà Cung Cấp");
        ...
        lblnhanvienphutrach3.setText("Mã Nhà Cung Cấp");
        ...
        lblMaNhaCungCap.setBackground(new java.awt.Color(255, 255, 255));
        lblMaNhaCungCap.setPreferredSize(new java.awt.Dimension(75, 20));

        lblTenNhaCungCap.setBackground(new java.awt.Color(255, 255, 255));
        lblTenNhaCungCap.setPreferredSize(new java.awt.Dimension(75, 20));
        ...
        lblMaSoThue.setBackground(new java.awt.Color(255, 255, 255));
        lblMaSoThue.setPreferredSize(new java.awt.Dimension(75, 20));

        lblnhanvienphutrach2.setBackground(new java.awt.Color(255, 255, 255));
        lblnhanvienphutrach2.setText("Mã Số Thuế");
        ...
        lblthongtinkhac2.setText("Thông Tin Giao Dịch");
        ...
        lblnhomkhachhang2.setText("Số Lần Nhập Hàng");
        lblnhomkhachhang2.setPreferredSize(new java.awt.Dimension(75, 20));

        lblSoLanNhapHang.setBackground(new java.awt.Color(255, 255, 255));
        lblSoLanNhapHang.setPreferredSize(new java.awt.Dimension(75, 20));
            ...
            .addGroup(pnlnenthongtinkhacLayout.createSequentialGroup()
                .addGroup(pnlnenthongtinkhacLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlnenthongtinkhacLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlnenthongtinkhacLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(pnlnenthongtinkhacLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(lblnhanvienphutrach3, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 107, Short.MAX_VALUE)
                    ...
                    .addGroup(pnlnenthongtinkhacLayout.createSequentialGroup()
                        .addGap(128, 128, 128)
                        .addGroup(pnlnenthongtinkhacLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lblMaNhaCungCap, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lblSoDienThaoi, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lblTenNhaCungCap, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(pnlnenthongtinkhacLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(pnlnenthongtinkhacLayout.createSequentialGroup()
                                ...
                                .addGroup(pnlnenthongtinkhacLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(lblMaSoThue, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        ...
                        .addGroup(pnlnenthongtinkhacLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(pnlnenthongtinkhacLayout.createSequentialGroup()
                                .addGroup(pnlnenthongtinkhacLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(lblnhanvienphutrach10, javax.swing.GroupLayout.DEFAULT_SIZE, 105, Short.MAX_VALUE))
                                .addGap(23, 23, 23)
                                .addGroup(pnlnenthongtinkhacLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(lblSoLanNhapHang, javax.swing.GroupLayout.PREFERRED_SIZE, 119, javax.swing.GroupLayout.PREFERRED_SIZE))))))
        ...
        pnlnenthongtinkhacLayout.setVerticalGroup(
            ...
            .addGroup(pnlnenthongtinkhacLayout.createSequentialGroup()
                ...
                .addGroup(pnlnenthongtinkhacLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(lblTenNhaCungCap, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(12, 12, 12)
                .addGroup(pnlnenthongtinkhacLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(pnlnenthongtinkhacLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(lblMaNhaCungCap, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(pnlnenthongtinkhacLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblnhanvienphutrach2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblMaSoThue, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(17, 17, 17)
                .addGroup(pnlnenthongtinkhacLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(pnlnenthongtinkhacLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblSoLanNhapHang, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        lblthongtincoban.setText("Lịch Sử Giao Dịch");

        tblCTNCC.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID", "STT", "Số Phiếu Nhập", "Ngày Nhập", "Số lượng Hàng Hóa", "Tổng Tiền ", "Nợ"
            }
        ) {
        ...
        tblCTNCC.setRowHeight(40);
        tblCTNCC.setShowVerticalLines(false);
        tblCTNCC.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblCTNCCMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tblCTNCC);
        if (tblCTNCC.getColumnModel().getColumnCount() > 0) {
            tblCTNCC.getColumnModel().getColumn(0).setMinWidth(0);
            tblCTNCC.getColumnModel().getColumn(0).setPreferredWidth(0);
            tblCTNCC.getColumnModel().getColumn(0).setMaxWidth(0);
        }
    ...
    private void btnTraNoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTraNoActionPerformed
        int dongduocchon = tblCTNCC.getSelectedRow();
        if (dongduocchon < 0) {
            ThongBaoCanhBao.ThongBao("Bạn Chưa Chọn Phiếu Nhập Để Trả Nợ !", "Thông Báo");
            return;
        }
        jdlTraNoNhaCungCap jdlTNNCC = new jdlTraNoNhaCungCap(new javax.swing.JFrame(), true);
        jdlTNNCC.setVisible(true);
    ...
    private void tblCTNCCMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCTNCCMouseClicked

    }//GEN-LAST:event_tblCTNCCMouseClicked
    ...
    private javax.swing.JLabel lblSoLanNhapHang;
    public static javax.swing.JLabel lblTenNhaCungCap;
    ...
    public static javax.swing.JTable tblCTNCC;
